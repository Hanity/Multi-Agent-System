...
public class ArcCoordinatorAgent extends GuiAgent {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private ArcGUI ArcGUI;
	...
	protected void setup() {
		...
		System.out.println("Welcome to Coordinator agent " + getAID().getName() + " is ready.");
	...
	protected void takeDown() {
		...
		System.out.println("I am Architect Coordinator Agent " + getAID().getName() + " is terminating.");
	...
	public class SendMessage extends OneShotBehaviour {
		...
		public void action() {
			...
			ArcGUI.setMessageTextArea(statusMessagesText);
